                ...
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge 
                                                ...
                                                @elseif($cita->estado == 'completada') bg-success
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">Agenda tu primera cita para vivir la experiencia de nuestra barbería</p>
                            <a href="{{ route('citas.create') }}" class="btn btn-gold">
...
function cargarDetalleCita(citaId) {
    ...
    fetch(`/citas/${citaId}/detalle`)
        ...
        .then(data => {
            ...
            // Construir el HTML con los detalles en el diseño que quieres
            const detallesHTML = `
                <div class="row">
                    <div class="col-md-12">
